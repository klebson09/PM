...
projetosDispDAO.prototype.consultarProjetoEquipe = function(idProjeto, callback){
  console.log("projetosDispDAO: consultarProjeto - ");
  var sql = "SELECT projeto.nomeProjeto, equipe.nomeEquipe, projeto.idContaUsuario FROM projeto INNER JOIN equipe ON projeto.idEquipe = equipe.IdEquipe WHERE projeto.idProjeto = "+idProjeto;
  console.log("sql = "+sql);
  this._connection.query(sql, callback);
}
