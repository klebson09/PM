...
CREATE TABLE IF NOT EXISTS `pm`.`conta_usuario` (
  ...
  `flagAlteracaoSenha` INT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `pm`.`timeline_msg` (
  ...
  INDEX `fk_timelineMsgs_conta_usuario1_idx` (`idContaUsuario` ASC),
  INDEX `fk_timeline_msg_equipe1_idx` (`idEquipe` ASC),
...
CREATE TABLE IF NOT EXISTS `pm`.`termo_abertura` (
  ...
  `respostaCliente` LONGTEXT NULL DEFAULT NULL,
